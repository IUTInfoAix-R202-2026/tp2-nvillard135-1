...
public class CalculatriceTriangle extends Application {
  ...
  private final Slider sliderX2 = new Slider(0, 10, 6);
  private final Slider sliderY2 = new Slider(0, 10, 0);
  private final Slider sliderX3 = new Slider(0, 10, 0);
  private final Slider sliderY3 = new Slider(0, 10, 3);
  ...
  public void start(Stage primaryStage) {
    ...
    Scene scene = new Scene(grille, 650, 750);
  ...
  void ajouterAire() {
    ...
    textFieldAire.setStyle(
        "-fx-control-inner-background: #eafaf1; -fx-text-fill: #27ae60; "
            + "-fx-font-weight: bold; -fx-border-color: #27ae60; -fx-border-width: 1.5; "
